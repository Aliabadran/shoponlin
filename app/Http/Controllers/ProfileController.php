...
class ProfileController extends Controller
{
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        // Add SweetAlert for successful profile update
        Alert::success('Profile Updated', 'Your profile has been updated successfully.');
        smilify('success', 'Your profile has been updated successfully.');
    ...
    public function destroy(Request $request): RedirectResponse
    {
        ...
        // Add SweetAlert for account deletion
        Alert::success('Account Deleted', 'Your account has been deleted successfully.');
        emotify('success', 'Your account has been deleted successfully.');
        return Redirect::to('/');
    }
}
