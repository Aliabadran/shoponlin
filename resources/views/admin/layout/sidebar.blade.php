      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('admin.feedback.manage') }}">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('/char') }}">
              <span class="menu-icon">
         ...
         <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
           ...
           @endcan
          @can('view notificationContent')
          <li class="nav-item menu-items">
            <a class="nav-link"   href="{{ url('/notificationsOffer') }}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
              <span class="menu-title">Sent notifications Offer</span>
            </a>
          </li>
          @endcan
