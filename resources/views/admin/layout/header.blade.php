 <!-- <div class="container-fluid page-body-wrapper">-->
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" action="{{ route('admin.check') }}" method="GET">
        ...
        @endauth
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="{{ route('admin.notifications') }}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
