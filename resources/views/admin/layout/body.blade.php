        ...
        <div class="main-panel">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal"> Total Cost</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"><div> ${{ number_format($totalRevenue, 2) }}</div></h3>
                    ...
                    <h6 class="text-muted font-weight-normal"><div>Revenue</div></h6>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                          <h2 class="mb-0">${{ number_format($totalPurchase , 2) }}</h2>
                      ...
                      <ul class="d-flex flex-column-reverse text-white todo-list todo-list-custom">
                        ...
                        <li>
                          <div class="form-check form-check-primary">
                            <label class="form-check-label">
                              <input class="checkbox" type="checkbox"> {{ $task->title }}</label>
                          </div>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Shop.com 2024</span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Online <a href="https://www.shop.com/bootstrap-admin-template/" target="_blank">Shop admin templates</a> from Shop.com</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
